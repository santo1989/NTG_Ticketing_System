 ...
 <nav class="sb-topnav navbar navbar-expand navbar-light bg-light text-white"
     ...
     <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
         ...
         <li class="nav-item dropdown">
             <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button"
                 data-bs-toggle="dropdown" data-bs-popper="static" aria-expanded="false"><img
                     src="{{ asset('images/users/' . auth()->user()->picture) }}" class="rounded-circle" width="50px"
                     height="50px" alt="{{ auth()->user()->name }}">
                 {{ auth()->user()->name ?? '' }}
             </a>
 ...
 <script>
     // Ensure dropdown menus appear above all elements
