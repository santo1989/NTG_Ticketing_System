        ...
        <div class="sb-sidenav-menu">
            @can('Admin')
                <div class="nav">
                    ...
                    <a class="nav-link collapsed " href="#" data-bs-toggle="collapse"
                        data-bs-target="#collapseLayoutsTickets" aria-expanded="false"
                        aria-controls="collapseLayoutsTickets">
                        <div class="sb-nav-link-icon"></div>
                        <h4 class="sb-sidenav-menu-heading" style="color:#40c47c;">Support Tickets</h4>
                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>

                    <div class="collapse" id="collapseLayoutsTickets" aria-labelledby="headingTickets"
                        data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{ route('admin.tickets.dashboard') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Admin Dashboard
                            </a>
                            ...
                            <a class="nav-link" href="{{ route('admin.tickets.reports') }}">
            ...
            @can('General')
                <div class="nav">
                    ...
                    <a class="nav-link " href="{{ route('client.tickets.dashboard') }}">
            ...
            @can('Supervisor')
                <div class="nav">
                    ...
                    {{-- Support Team Ticket System start --}}
                    <a class="nav-link collapsed " href="#" data-bs-toggle="collapse"
                        data-bs-target="#collapseLayoutsSupportTickets" aria-expanded="false"
                        aria-controls="collapseLayoutsSupportTickets">
                        <div class="sb-nav-link-icon"></div>
                        <h4 class="sb-sidenav-menu-heading" style="color:#40c47c;">Support Tickets</h4>
                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>

                    <div class="collapse" id="collapseLayoutsSupportTickets" aria-labelledby="headingSupportTickets"
                        data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{ route('support.tickets.dashboard') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Support Dashboard
                            </a>
                            <a class="nav-link" href="{{ route('support.tickets.my-tickets') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-tasks"></i></div>
                                My Assigned Tickets
                            </a>
                        </nav>
                    </div>
                    {{-- Support Team Ticket System end --}}
