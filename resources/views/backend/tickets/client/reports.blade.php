<x-backend.layouts.master>
    ...
    <x-slot name='breadCrumb'>
        <x-backend.layouts.elements.breadcrumb>
            ...
            <x-slot name="add">
                ...
                <a href="{{ route('client.tickets.reports.download', request()->query()) }}"
    ...
    <div class="container-fluid">
        <div class="card mb-3">
            <div class="card-body">
                <form action="{{ route('client.tickets.reports') }}" method="GET" class="form-inline">
                    ...
                    <a href="{{ route('client.tickets.reports') }}" class="btn btn-secondary mb-2">
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover" id="myClientReportsTable">
                        <thead>
                            <tr>
                                <th>Ticket #</th>
                                <th>Subject</th>
