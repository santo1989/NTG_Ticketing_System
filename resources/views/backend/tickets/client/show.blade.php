        ...
        <x-backend.layouts.elements.breadcrumb>
            ...
            <x-slot name="add">
                ...
                @if ($ticket->canBeEditedByClient())
                    <a href="{{ route('client.tickets.edit', $ticket) }}" class="btn btn-sm btn-warning">
            ...
            <div class="col-md-8">
                ...
                @if ($ticket->review)
                    <div class="card mt-3">
                        <div class="card-header bg-success text-white">
                            <h6 class="mb-0"><i class="fas fa-star"></i> Your Review</h6>
                        </div>
                        <div class="card-body">
                            ...
                            @if ($ticket->review->rating === 'Dissatisfied')
                                <div class="mt-2">
                                    <a href="{{ route('client.tickets.review', $ticket) }}"
                                        class="btn btn-sm btn-outline-warning">
                                        <i class="fas fa-edit"></i> Revise Review
                                    </a>
                                </div>
                            @endif
                        </div>
                ...
                @elseif($ticket->isCompleted())
                    <div class="alert alert-info">
                        <i class="fas fa-star"></i> This ticket is completed.
                        <a href="{{ route('client.tickets.review', $ticket) }}" class="btn btn-sm btn-success">
                            Give Review
                        </a>
                    </div>
                @endif
                ...
                <div class="card mt-3">
                    <div class="card-header bg-info text-white">
                        <h6 class="mb-0"><i class="fas fa-history"></i> Ticket History</h6>
                    </div>
                    <div class="card-body">
