                            ...
                            <div class="col-md-2 col-xl-2">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @php
                                            $designation = App\Models\Designation::where(
                                                'id',
                                                $parent_details->designation_id,
                                            )->first();
                                            $departmrnt = App\Models\Department::where(
                                                'id',
                                                $parent_details->department_id,
                                            )->first();
                                        @endphp
                                        <h6 class="card-subtitle mb-2 text-muted ">{{ $designation->name ?? 'No Data' }},
                                            {{ $departmrnt->name }}</h6>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @php
                                                $designation = App\Models\Designation::where(
                                                    'id',
                                                    $child_details->designation_id,
                                                )->first();
                                                $departmrnt = App\Models\Department::where(
                                                    'id',
                                                    $child_details->department_id,
                                                )->first();
                                            @endphp
                                            <h6 class="card-subtitle mb-2 text-muted ">
                                                {{ $designation->name ?? 'No Data' }}, {{ $departmrnt->name }}</h6>
