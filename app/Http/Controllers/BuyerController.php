...
class BuyerController extends Controller
{
    public function index()
    {
        ...
        return view('backend.library.buyers.index', compact('buyers', 'companies'));
    }
    ...
    public function create()
    {
        $buyers = Buyer::all();
        $companies = Company::all();
        return view('backend.library.buyers.create', compact('buyers', 'companies'));
    }
    ...
    public function show($id)
    {
        ...
        $companies = Company::all();
        return view('backend.library.buyers.show', compact('buyer', 'companies'));
    }
    ...
    public function edit($id)
    {
        $buyer = Buyer::findOrFail($id);
        $companies = Company::all();
        return view('backend.library.buyers.edit', compact('buyer', 'companies'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($buyer->name == strtoupper($request->name) && $buyer->company_id == $request->company_id) {
