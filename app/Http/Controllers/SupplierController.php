...
class SupplierController extends Controller
{
    public function index()
    {
        ...
        return view('backend.library.suppliers.index', compact('suppliers', 'companies'));
    }
    ...
    public function create()
    {
        $suppliers = Supplier::all();
        $companies = Company::all();
        return view('backend.library.suppliers.create', compact('suppliers', 'companies'));
    }
    ...
    public function show($id)
    {
        ...
        $companies = Company::all();
        return view('backend.library.suppliers.show', compact('supplier', 'companies'));
    }
    ...
    public function edit($id)
    {
        $supplier = Supplier::findOrFail($id);
        $companies = Company::all();
        return view('backend.library.suppliers.edit', compact('supplier', 'companies'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($supplier->name == strtoupper($request->name) && $supplier->company_id == $request->company_id) {
